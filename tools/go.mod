// Module for code-generation tooling only.
//
// Kept separate from the server module so that buf and the protoc plugins --
// which pull a large dependency tree -- never appear in the server's go.mod or
// its build graph. Renovate updates this file independently.
module github.com/ctrl-research/mmo/tools
